...
### 🚗 What I do
- I am enthusiastic in hardware design and embedded systems. 
...
- I regularly write blogs on [my technical blog](https://tungnguyen1610.github.io/Tung_Blog/author/tung-nguyen.html)
### 🌱 What I'm learning
- Continuously exploring the latest in **bare-metal programming**, **RTOS**, and **embedded Linux**.
- Deepening my knowledge of **digital IC design** and **software architecture for embedded systems**.

### 👯 I'm looking to collaborate on
- Projects involving **IC design**, **microcontroller programming**, **low-level drivers**, or **automotive applications**.

### 💬 Ask me about
- Digital Design and Computer Architecture
- AUTOSAR (Classic & Adaptive)
- CAN, LIN, FlexRay, and other communication stacks
- MCU programming (ARM Dual Cortex, STM32, BeagleBoard, etc.)
- Embedded Linux
